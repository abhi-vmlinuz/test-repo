...
const PricingPage = () => {
    ...
    const [rollingDigits, setRollingDigits] = useState([9]);
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            if (index < numbers.length) {
                setRollingDigits([numbers[index]]);
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: 'You can always reach us at support@ZecurX LABS.com or through our Discord community. We typically respond within 24 hours.',
        },
    ];
        ...
        <div className="min-h-screen bg-white relative">
            ...
            <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
                <div className="w-full px-8 lg:px-16 py-4 flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        <Link to="/" className="text-gray-500 hover:text-gray-900 transition-colors text-sm font-medium">Home</Link>
            ...
            <section className="pt-32 pb-12 relative z-10">
                <div className="w-full px-8 lg:px-16 text-center">
                    ...
                    {/* Monthly/Yearly Toggle - Fixed alignment */}
                    ...
                    <div className="flex flex-col lg:flex-row justify-center gap-8 max-w-4xl mx-auto">
                        {plans.map((plan, index) => (
                            ...
                            >
                                ...
                                {/* CTA - Rainbow button for premium */}
                                {plan.popular ? (
                                    <Link to="/login">
            ...
            {/* Testimonials Section - Trusted by experts */}
                ...
                <div className="w-full">
                    ...
                    <div className="flex justify-center gap-2 mt-8">
                        {testimonials.map((_, index) => (
                            <div
                                key={index}
                                className={`h-1 rounded-full transition-all ${index === 2 ? 'w-8 bg-gray-900' : 'w-8 bg-gray-200'
                                    }`}
                            />
                        ))}
                    </div>
            ...
            {/* CTA Section - With spacing from edges */}
