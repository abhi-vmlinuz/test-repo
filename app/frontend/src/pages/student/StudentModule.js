                            ...
                            {topic.challenges.filter(c => !c.is_capstone).map((challenge) => {
                                ...
                                return (
                                    <Link
                                        ...
                                        className={`block bg-white rounded-xl border border-gray-100 p-5 hover:shadow-md transition-all ${isComplete ? 'bg-gray-50' : ''
                                            }`}
                                    >
                        ...
                        <div className="space-y-3">
                            {capstoneChallenges.map((challenge) => {
                                ...
                                return (
                                    <div
                                        key={challenge.id}
                                        className={`bg-white rounded-xl border-2 p-5 transition-all ${isComplete
