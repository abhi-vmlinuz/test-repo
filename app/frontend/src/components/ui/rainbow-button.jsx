    ...
    return (
        <button
            className={cn(
                ...
                // before styles - enhanced glow effect (stronger blur, larger size)
                "before:absolute before:bottom-[-25%] before:left-1/2 before:z-0 before:h-2/5 before:w-4/5 before:-translate-x-1/2 before:animate-rainbow before:bg-[linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-5)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-2)))] before:bg-[length:200%] before:[filter:blur(calc(1.2*1rem))] before:opacity-80",

                // background with rainbow border (thicker border effect)
